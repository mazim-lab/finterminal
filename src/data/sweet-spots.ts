...
export const SWEET_SPOTS: SweetSpot[] = [
  {
    slug: "avios-jetblue-mint-transcon-qatar-38750",
    program: "Avios",
    title: "Avios sweet spot: lie-flat JetBlue Mint across the US for a flat 38,750 Avios one-way, surcharge-free through Qatar",
    dek: "JetBlue sits in no alliance, and of all the Avios programs only Qatar Airways Privilege Club can book its flights, so the freshest value in the currency is a lie-flat JetBlue Mint seat between New York or Boston and Los Angeles or San Francisco for a fixed 38,750 Avios one-way, plus only about $5.60 in tax because JetBlue never adds a fuel surcharge.",
    read: "5 min read",
    date: "Sep 2026",
    lastChecked: "2026-09-11",
    body:
      "Avios is the shared currency behind British Airways, Iberia, Aer Lingus, Finnair, and Qatar Airways, and one balance moves freely between them at the same rate. We have already walked through the off-peak Iberia business run to Madrid, the friendly Aer Lingus hop to Dublin, and the showstopper Qatar Qsuites flight to Doha, so this time the target is a quieter one that only opened up recently and that most Canadians have never thought to book: a lie-flat JetBlue Mint seat across the United States for about 38,750 Avios one-way. The figures below are an example of how the pricing works, not a quote for any date, so always confirm the live price when you search.\n\nHere is how it works, and it comes with one important wrinkle. JetBlue is not in an alliance, and of all the Avios programs only Qatar Airways Privilege Club can book its flights, a partnership that opened in late 2023. Qatar prices JetBlue on a fixed, JetBlue-specific rate rather than a dynamic fare or the standard Avios distance chart, and the standout number is the transcontinental one: a JetBlue Mint business seat between New York JFK or Boston and Los Angeles or San Francisco books for a flat 38,750 Avios one-way, the same price on every date. Shorter Mint routes run less, from around 12,500 Avios, and plain JetBlue economy starts as low as 6,000. Because the rate is fixed there is no peak pricing to dodge, though Qatar can adjust the JetBlue rate over time, so treat 38,750 as the current framework and price your own dates.\n\nHere is the cents-per-point math on a realistic Mint booking. Say a one-way transcontinental Mint fare from New York to Los Angeles would run about $1,000 in cash, a normal price on a busy date for this lie-flat product, and the award books for 38,750 Avios plus roughly $5.60 in taxes, because JetBlue adds no fuel surcharge and the only cash due is the US departure fee. That works out to (1000 minus 5.60) divided by 38750, times 100, which is about 2.6 cents per Avios. Anything above about 1.5 cents is a strong use of Avios, so a flat bed across the country at this price is your points doing real work, and if you caught one of RBC's periodic 30 percent transfer bonuses on the way in, the effective value climbs higher still. Prices move, so confirm the live fare when you book.\n\nA couple of things make it sing. The no-surcharge part is the durable edge, because JetBlue never levies carrier-imposed fuel surcharges, so a transcontinental Mint award costs the Avios plus that tiny $5.60 and nothing more, which is a rarity in a hobby where fees quietly eat the value. Mint itself is a genuine lie-flat business cabin, with private suites and a door on the newest transcontinental jets, so this is a real bed and a proper meal on a five-plus-hour daytime or overnight crossing rather than a recliner. And the fixed 38,750 rate means you are not fighting the dynamic pricing that balloons a cash Mint fare on busy dates, since the Avios number holds steady whether you fly on a quiet Tuesday or a packed holiday Friday.\n\nFor Canadians the earning is refreshingly doable, even though no Canadian bank transfers to Qatar directly. RBC Avion moves to British Airways Avios at 1 to 1 and runs a 30 percent transfer bonus a couple of times a year, and Amex Membership Rewards in Canada feeds Avios as well; once the points land in British Airways you use the Combine my Avios tool to shift them into Qatar Privilege Club, where the JetBlue award lives, and that move between Avios programs is instant and 1 to 1.\n\nNow the honest caveats, and there are a few. Only Qatar Privilege Club can book JetBlue, so you need a Qatar account and have to move your Avios there before you can even see the award, which is a step the Iberia and Aer Lingus redemptions do not ask for. Mint is a small cabin, usually just a couple of rows, so saver-style space is genuinely limited and the best dates go early, so search a wide range and pounce when a seat shows. The value only really lands when the Mint cash fare is high, so on a $499 promo Mint fare the 38,750 Avios can come out worse than just paying, which means you should run the cents-per-point math before you book. Steer clear of the JetBlue Mint flights to Europe on Avios, because those carry heavy carrier-imposed surcharges that can top several hundred dollars and wreck the value, so the transcontinental and Caribbean routes are where this sweet spot actually sings. And because JetBlue does not fly Mint from Canada, you position to New York or Boston on a separate ticket or a short Avios hop first, so price that leg in, and remember transfers are one-way and the fixed rate can be adjusted, so only move points once you have found the seat you want.",
    href: "/travel/avios-sweet-spots-rbc-avion-transfer",
    hrefLabel: "Full Avios guide",
    shortAnswer:
      "Avios is shared across British Airways, Iberia, Aer Lingus, Finnair, and Qatar Airways, and of all of them only Qatar Airways Privilege Club can book JetBlue, which makes a lie-flat JetBlue Mint seat across the United States one of the freshest Avios sweet spots going. Qatar prices it on a fixed JetBlue-specific rate, so a transcontinental Mint business seat from New York JFK or Boston to Los Angeles or San Francisco books for a flat 38,750 Avios one-way on every date, plus only about $5.60 in tax because JetBlue adds no fuel surcharge. On a roughly $1,000 one-way Mint cash fare that is about 2.6 cents per Avios, well above the 1.5 cents that already counts as a strong use, and it climbs higher if you caught one of RBC Avion's periodic 30 percent transfer bonuses. Canadians build the balance through RBC Avion or Amex Membership Rewards into British Airways Avios, then use the Combine my Avios tool to move it into Qatar Privilege Club where the award lives. Just steer clear of the Mint flights to Europe, which carry heavy surcharges, position from Canada to a US gateway, and confirm the live price, since the fixed rate can be adjusted.",
    faqs: [
      {
        q: "How many Avios is JetBlue Mint across the US?",
        a: "A transcontinental JetBlue Mint business seat between New York JFK or Boston and Los Angeles or San Francisco books for a flat 38,750 Qatar Avios one-way, the same price on every date. Shorter Mint routes run less, from around 12,500 Avios, and plain JetBlue economy starts as low as 6,000. Qatar can adjust the JetBlue rate over time, so treat 38,750 as the current framework and confirm the live price when you search.",
      },
      {
        q: "Is JetBlue Mint a good value on Avios?",
        a: "Yes, when the cash fare is high. On a roughly $1,000 one-way transcontinental Mint fare booked for 38,750 Avios plus about $5.60 in tax, the math is (1000 minus 5.60) divided by 38750, times 100, which is about 2.6 cents per Avios. Anything above about 1.5 cents is a strong use of Avios, so a flat bed across the country at this price is your points doing real work, and it climbs higher if you caught a 30 percent transfer bonus on the way in.",
      },
      {
        q: "Which Avios program can book JetBlue?",
        a: "Only Qatar Airways Privilege Club. JetBlue is not in an alliance, and of all the Avios programs Qatar is the single one that can book its flights, a partnership that opened in late 2023. That means you need a Qatar Privilege Club account and have to move your Avios there before you can even see the award, a step the Iberia and Aer Lingus redemptions do not ask for.",
      },
      {
        q: "Does booking JetBlue with Avios have fuel surcharges?",
        a: "Not on the transcontinental routes. JetBlue never levies carrier-imposed fuel surcharges, so a transcon Mint award costs the Avios plus roughly $5.60 in US departure tax and nothing more. The exception is JetBlue Mint to Europe, which carries heavy carrier-imposed surcharges that can top several hundred dollars, so stick to the transcontinental and Caribbean routes where this sweet spot actually sings.",
      },
      {
        q: "How do Canadians earn the Avios for this?",
        a: "No Canadian bank transfers to Qatar directly, but RBC Avion moves to British Airways Avios at 1 to 1 and runs a 30 percent transfer bonus a couple of times a year, and Amex Membership Rewards in Canada feeds Avios too. Once the points land in British Airways you use the Combine my Avios tool to shift them into Qatar Privilege Club, where the JetBlue award lives, and that move is instant and 1 to 1. Transfers are one-way, so only move points once you have found the seat you want.",
      },
      {
        q: "When is this sweet spot not worth it?",
        a: "On a cheap fare or the wrong route. Because the rate is a fixed 38,750 Avios, a discounted $499 promo Mint fare can come out worse than simply paying cash, so run the cents-per-point math first. Skip the Mint flights to Europe, which carry heavy surcharges, and remember Mint is a small cabin with limited space, and JetBlue does not fly Mint from Canada, so you position to New York or Boston first.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    dek: "Flying Blue prices awards dynamically with no fixed chart, but Air France's nonstop from Los Angeles to Papeete is the durable way to reach Tahiti on points, from about 35,000 miles one-way in economy and around 90,000 in the lie-flat business cabin, and the quiet second act is Air Tahiti's fixed-price inter-island awards, where Papeete to Bora Bora runs about 15,000 miles plus roughly $22.",
    read: "5 min read",
    date: "Sep 2026",
    lastChecked: "2026-09-04",
    body:
      "Flying Blue, the shared program behind Air France, KLM, and their SkyTeam partners, prices awards dynamically with no published chart, and it is only fair to repeat that before we talk value. We have already walked through the marquee transatlantic sweet spot, a lie-flat business seat to Europe in the monthly Promo Rewards, and the quiet everyday one, hopping around Europe in short-haul economy, so this time the target is a proper bucket-list trip Canadians rarely think to book with points: the South Pacific. Air France flies nonstop from Los Angeles to Tahiti, and Flying Blue prices that route far more kindly than the eye-watering cash fare, with a neat second act on the little inter-island turboprops once you land. The figures below are an example of how the pricing works, not a quote for any date, so always confirm the live price when you search.\n\nHere is how it works. Air France runs the only nonstop from North America to Papeete, out of Los Angeles, and on Flying Blue that seat starts around 35,000 miles one-way in economy on the quieter dates, with premium economy near 50,000 and the lie-flat business cabin around 90,000. Because Flying Blue is dynamic, treat those as saver floors that climb on peak dates rather than a fixed quote, and the quietest dates can dip a touch below 35,000 in economy. The quieter half of this sweet spot is genuinely durable: Air France now lets you spend Flying Blue miles on Air Tahiti, the regional turboprop airline that reaches the outer islands, at fixed per-route prices, so Papeete to Bora Bora runs about 15,000 miles plus roughly $22, Papeete to Moorea about 6,000 plus roughly $28, and the longest island hops top out near 30,000. That inter-island chart is fixed rather than dynamic, so it is the rare Flying Blue price you can actually plan around. Price your own dates on the long-haul leg before you assume a number.\n\nHere is the cents-per-mile math on a realistic economy booking. Say a one-way Los Angeles to Papeete economy fare would run about $1,100 in cash, a normal price on this pricey leisure route, and the award books for 35,000 miles plus roughly $130 in taxes and fees. That works out to (1100 minus 130) divided by 35000, times 100, which is about 2.8 cents per mile. Across the whole program a Flying Blue mile is worth a little over a cent on average, so anything north of about 1.5 cents is a strong use, and this clears that comfortably. If you catch the lie-flat business cabin the math is better still: on a roughly $5,000 one-way business fare booked for 90,000 miles plus about $150, that is (5000 minus 150) divided by 90000, times 100, or about 5.4 cents per mile. Prices move, so confirm the live fare when you book.\n\nA couple of things make it sing. Air France is the only airline flying North America to Tahiti nonstop that Flying Blue can book, since the low-cost French Bee that also serves the route is not a transfer partner, so the miles unlock a trip that is otherwise a genuine splurge in cash. The route never touches France, so unlike an Air France award routed through Paris the fuel surcharges stay modest in both directions, which keeps the cash portion in the low hundreds rather than the several hundred a European return can carry. And because the Air Tahiti inter-island awards run on the same Flying Blue balance at those fixed prices, one currency gets you from home all the way out to an overwater bungalow, with the short hop from Papeete to Bora Bora costing about 15,000 miles rather than a separate pricey cash ticket. For Canadians the earning is friendly, because as of January 2026 Amex Canada moved its Membership Rewards transfer to Flying Blue to a clean 1 to 1, which makes Amex the most direct way to build the balance.\n\nNow the honest caveats, and there are a few. The long-haul leg is dynamically priced, so 35,000 miles in economy and 90,000 in business are saver floors, not promises, and peak summer, the December holidays, and school breaks can push them well past double, so search a wide range of dates and pounce when a low price shows. Business saver space in particular is genuinely limited on a route this popular, so economy is the more reliably bookable version of the trip. There is no nonstop from Canada, so you position to Los Angeles on a separate ticket or a short Aeroplan or Avios hop and start the Tahiti leg there, so price that in before you assume the whole trip is cheap. The Air Tahiti inter-island awards can only be booked on the Air France website, not through KLM, and those flights are turboprop economy only, so there is no premium cabin to chase on the islands. And if Amex is not your currency, Marriott Bonvoy feeds Flying Blue at 3 to 1 with a 5,000-mile bonus for every 60,000 points moved in one block, so 60,000 Bonvoy points land as 25,000 miles, a slower but workable backup. Transfers are one-way, so only move points once you have found the seat you want, and confirm the current ratios and the live award price before you commit.",
    href: "/cards?q=amex",
    hrefLabel: "Amex cards that feed Flying Blue",
    shortAnswer:
      "Flying Blue prices awards dynamically with no fixed chart, but Air France's nonstop from Los Angeles to Papeete is the durable way to reach Tahiti on points, starting around 35,000 miles one-way in economy on quieter dates, with premium economy near 50,000 and the lie-flat business cabin around 90,000. On a roughly $1,100 one-way economy cash fare booked for 35,000 miles plus about $130 in taxes, that is around 2.8 cents per mile, above the roughly 1 cent a Flying Blue mile is worth on average, and business works out closer to 5.4 cents. Because the route never touches France the fuel surcharges stay modest, and the same Flying Blue balance also books Air Tahiti's fixed-price inter-island hops, so Papeete to Bora Bora runs about 15,000 miles plus roughly $22. For Canadians the cleanest feed is Amex Membership Rewards, which moved to a clean 1 to 1 transfer in January 2026, with Marriott Bonvoy at 3 to 1 as a backup, but the long-haul price is dynamic, so treat 35,000 as a saver floor and confirm the live price when you search.",
    faqs: [
      {
        q: "How many Flying Blue miles is Air France to Tahiti?",
        a: "Air France's nonstop from Los Angeles to Papeete starts around 35,000 miles one-way in economy on quieter dates, with premium economy near 50,000 and the lie-flat business cabin around 90,000. Flying Blue prices this route dynamically, so treat those as saver floors that climb on peak dates, and confirm the live price when you search.",
      },
      {
        q: "Is flying to Tahiti a good value on Flying Blue miles?",
        a: "Yes. On a roughly $1,100 one-way Los Angeles to Papeete economy cash fare booked for 35,000 miles plus about $130 in taxes, the math is (1100 minus 130) divided by 35000, times 100, which is about 2.8 cents per mile. A Flying Blue mile is worth a little over a cent on average, so anything north of about 1.5 cents is a strong use, and the lie-flat business cabin at around 90,000 miles works out closer to 5.4 cents.",
      },
      {
        q: "Can I use Flying Blue miles to reach Bora Bora?",
        a: "Yes, and this is the durable half of the sweet spot. Air France lets you spend Flying Blue miles on Air Tahiti, the regional turboprop airline, at fixed per-route prices, so Papeete to Bora Bora runs about 15,000 miles plus roughly $22 and Papeete to Moorea about 6,000 plus roughly $28. That inter-island chart is fixed rather than dynamic, so it is the rare Flying Blue price you can plan around, though those Air Tahiti awards can only be booked on the Air France website, not through KLM.",
      },
      {
        q: "Are the fuel surcharges high on this award?",
        a: "No, they stay modest, which is part of the appeal. The route never touches France, so unlike an Air France award routed through Paris the surcharges stay low in both directions, keeping the cash portion in the low hundreds, roughly $130 one-way in economy, rather than the several hundred a European return can carry.",
      },
      {
        q: "How do Canadians earn Flying Blue miles for this?",
        a: "As of January 2026, Amex Canada moved its Membership Rewards transfer to Flying Blue to a clean 1 to 1, which makes Amex the most direct way to build the balance. Marriott Bonvoy is a backup at 3 to 1 with a 5,000-mile bonus for every 60,000 points moved in one block, so 60,000 Bonvoy points land as 25,000 miles. Transfers are one-way, so only move points once you have found the seat you want.",
      },
      {
        q: "Can I fly to Tahiti nonstop from Canada?",
        a: "No, that is the main catch on the routing. Air France flies the only Flying Blue-bookable nonstop from North America out of Los Angeles, so you position to LAX on a separate ticket or a short Aeroplan or Avios hop and start the Tahiti leg there. Business saver space is also genuinely limited on this popular route, so economy is the more reliably bookable version of the trip.",
      },
    ],
  },
  {
    slug: "alaska-starlux-business-taipei-75k",
    program: "Alaska",
    title: "Alaska sweet spot: Starlux business class to Taipei from about 75,000 Atmos points, no fuel surcharges",
    dek: "Alaska's Mileage Plan is now Atmos Rewards, but it still prices partner awards off a fixed distance chart with no fuel surcharges, so a fresh, distinct sweet spot is a lie-flat Starlux suite from the US West Coast to Taipei at a saver floor of about 75,000 points one-way, with economy at 37,500, plus only around $20 in taxes and a partner fee.",
    read: "5 min read",
    date: "Sep 2026",
    lastChecked: "2026-09-01",
    body:
      "Alaska's frequent flyer program became Atmos Rewards in 2026, but the reason award collectors still love it is unchanged, so it is worth saying up front. While almost every US program has drifted to dynamic pricing, Atmos still prices its partner awards off a fixed, distance based chart, and it does not pass along the carrier imposed fuel surcharges that quietly sink the value on some other programs. We have already walked through two Atmos long hauls, Japan Airlines business from Vancouver or Seattle to Tokyo and the marquee Qantas run across the Pacific to Australia, so this time the target is a newer and quieter one that Canadians rarely think to book: Starlux business class to Taipei, on one of the best new premium cabins flying. The figures below are an example of how the chart works, not a quote for any date, so always confirm the live price when you search.\n\nThe numbers look like this. Starlux flies nonstop to Taipei from Seattle, San Francisco, and Los Angeles, and all three sit in the 5,001 to 7,000 mile band of the Atmos Asia Pacific partner chart, which puts business class at a floor of about 75,000 points one-way and economy at 37,500. Taipei is a fine destination in its own right and a tidy hub onward into the rest of Asia, and because Atmos lets you add a free stopover on a one-way partner award you can break the trip in Taiwan on the way somewhere else. This is a distance based chart, so treat 75,000 as the saver floor rather than a promise, and price your own dates before you assume a number.\n\nHere is the cents-per-point math on a realistic business booking. Say a one-way Starlux business fare from Los Angeles or San Francisco to Taipei would run about $4,500 in cash, and the award books for 75,000 points plus roughly $20 in taxes and fees. Because Atmos strips the fuel surcharges and the US and Taiwan departure taxes are light, the cash portion stays tiny, often around $20 all in once you add the partner award fee that rose to $20 on July 1 2026. That works out to (4500 minus 20) divided by 75000, times 100, which is about 6 cents per point. Anything above about 1.5 cents is a strong use of Atmos points, so a lie-flat suite to Asia at this price is your points doing real work. Prices move, so confirm the live fare when you book.\n\nA couple of things make it sing. Starlux is a genuinely new airline flying a young Airbus A350 fleet, and its business class is a proper lie-flat suite with a closing door and direct aisle access for every seat, plated multi course dining, and a cabin reviewers rate among the best of the new premium products, so this is a real bed and then some for the long overnight crossing. The no-surcharge policy is the durable edge, because the same seat booked through some other programs can carry hundreds of dollars in carrier fees, while Atmos keeps the cash portion to that small partner fee and modest taxes. And the free enroute stopover means one 75,000 point redemption can become two destinations, Taipei plus an onward Asian city, on a single booking.\n\nNow the honest caveats, and there are a few. The biggest one is availability, because saver business space at 75,000 is genuinely hard to find, and when the cheap seats are gone Starlux business often prices far higher, commonly up around 175,000 points, which is no deal at all. So treat 75,000 as an alert target to pounce on rather than a number you can count on, search a wide range of dates with Alaska's calendar tool, and know that economy from 37,500 has much better availability and prices just as cleanly. On a roughly $800 one-way economy cash fare that is (800 minus 20) divided by 37500, times 100, about 2.1 cents per point, which makes economy the more reliably bookable version of this trip. Earning the points is the other hard part for Canadians, because no Canadian bank transfers directly to Atmos: the cleanest route is Marriott Bonvoy, which moves at 3 to 1 with a 5,000-point bonus for every 60,000 Bonvoy points you transfer in one block, so 60,000 Bonvoy points land as 25,000 Atmos points and the 75,000 for this seat take on the order of 180,000 Bonvoy points to build. Plan the transfer around a real booking and confirm the current ratio first, since transfers are one-way. And because you are starting from Canada you will still position to Seattle, San Francisco, or Los Angeles to catch the nonstop, so price that leg in before you assume the whole trip is cheap.",
    href: "/cards?q=marriott",
    hrefLabel: "Bonvoy cards that feed Atmos Rewards",
    shortAnswer:
      "Alaska's Mileage Plan is now Atmos Rewards, but it still prices partner awards off a fixed distance chart with no fuel surcharges, and a fresh, distinct Atmos sweet spot is Starlux business class from the US West Coast to Taipei, which sits at a saver floor of about 75,000 points one-way with economy at 37,500, plus only around $20 in taxes and a partner fee. On a roughly $4,500 one-way business cash fare that is about 6 cents per point, well above the 1.5 cents that already counts as a strong use, for one of the best new lie-flat suites flying. The real catch is availability, because saver business space at 75,000 is hard to find and Starlux business often prices far higher, commonly up around 175,000, so treat 75,000 as an alert target and lean on economy from 37,500 for its much better availability. Earning is the hard part for Canadians, since no Canadian bank transfers directly to Atmos and the cleanest route is Marriott Bonvoy at 3 to 1 with a 5,000-point bonus per 60,000-point block, so 60,000 Bonvoy land as 25,000 Atmos and the 75,000 for this seat take on the order of 180,000 Bonvoy to build.",
    faqs: [
      {
        q: "How many Atmos points is Starlux business class to Taipei?",
        a: "The nonstop from Seattle, San Francisco, or Los Angeles to Taipei sits in the 5,001 to 7,000 mile band of the Atmos Asia Pacific partner chart, which puts business class at a saver floor of about 75,000 points one-way and economy at 37,500. Atmos prices partner awards off a fixed distance chart, so treat 75,000 as the saver floor rather than a promise and confirm the live price when you search.",
      },
      {
        q: "Is Starlux business to Taipei a good value on Atmos points?",
        a: "Yes, when you catch the saver price. On a roughly $4,500 one-way business cash fare booked for 75,000 points plus about $20 in taxes and the partner fee, the math is (4500 minus 20) divided by 75000, times 100, which is about 6 cents per point. Anything above about 1.5 cents is a strong use of Atmos points, so a lie-flat suite to Asia at this price is your points doing real work.",
      },
      {
        q: "Does Atmos charge fuel surcharges on Starlux awards?",
        a: "No, and that is the durable edge of this sweet spot. Atmos does not pass along carrier-imposed fuel surcharges, so the cash portion stays to a small partner award fee, which rose to $20 on July 1 2026, plus light US and Taiwan departure taxes, often around $20 all in. The same seat booked through some other programs can carry hundreds of dollars in fees.",
      },
      {
        q: "Is the 75,000 point saver price reliably available?",
        a: "No, that is the main catch. Saver business space at 75,000 is genuinely hard to find, and when the cheap seats are gone Starlux business often prices far higher, commonly up around 175,000 points, which is no deal. Treat 75,000 as an alert target to pounce on, search a wide range of dates with Alaska's calendar tool, and remember economy from 37,500 has much better availability at about 2.1 cents per point.",
      },
      {
        q: "How do Canadians earn Atmos points for this?",
        a: "It is the hard part, because no Canadian bank transfers directly to Atmos. The cleanest route is Marriott Bonvoy, which moves at 3 to 1 with a 5,000-point bonus for every 60,000 Bonvoy points you transfer in one block, so 60,000 Bonvoy points land as 25,000 Atmos points. That means the 75,000 points for this seat take on the order of 180,000 Bonvoy points to build, so confirm the current ratio first, since transfers are one-way.",
      },
      {
        q: "Can I add a stopover or fly nonstop from Canada?",
        a: "Atmos lets you add a free enroute stopover on a one-way partner award, so you can break the trip in Taipei on the way to another Asian city and turn one 75,000 point redemption into two destinations. Starlux does not fly from Canada, though, so you will still position to Seattle, San Francisco, or Los Angeles to catch the nonstop, so price that leg in before you assume the whole trip is cheap.",
      },
    ],
  },
  {
    slug: "united-star-alliance-business-africa-88k",
    program: "United",
    ...
    body:
      "United MileagePlus works differently from a fixed-chart program like Aeroplan, and it is worth saying so before we talk value. United prices its own flights dynamically, so a seat on United metal floats with the cash fare, and the real value hides in the partners. Book a Star Alliance partner through United and the price still sits at United's semi-fixed Saver levels rather than the floating fare, and United does not pass along the carrier-imposed fuel surcharges that some partners are known for. We already walked through the Europe version of that idea on Lufthansa and SWISS and the marquee ANA The Room to Tokyo, so this time the target is a bucket-list trip Canadians rarely think to book with points, a lie-flat seat to Africa on EgyptAir or Ethiopian. The figures below are an example of how the Saver levels work, not a quote for any date, so always confirm the live price when you search.\n\nThe numbers look like this. North America to Africa in business on a Star Alliance partner has been landing in a band that starts around 88,000 miles one-way at the Saver level, with economy on the same partners from roughly 45,000. EgyptAir flies the Atlantic nonstop to Cairo from New York JFK, Newark, and Washington Dulles, with Los Angeles and Chicago joining the map in 2026, and Ethiopian serves the US toward its Addis Ababa hub, the gateway to a safari in Kenya, Tanzania, or South Africa on one connecting ticket. United no longer publishes a single fixed partner chart the way it once did, so treat 88,000 as an approximate floor rather than a promise, with busier dates and the deeper African cities pricing higher, and price your own dates before you assume a number.\n\nHere is the cents-per-mile math on a realistic business booking. Say a one-way business fare from the US East Coast to Cairo would run about $4,500 in cash, and the award books for 88,000 miles plus roughly $80 in taxes and fees. Because United absorbs the fuel surcharges and the US departure taxes stay modest, the cash portion stays small. That works out to (4500 minus 80) divided by 88000, times 100, which is about 5 cents per mile. Anything north of about 1.5 cents is a strong use of United miles, so a flat bed to Africa at this price is your miles doing real work. Prices move, so confirm the live fare when you book.\n\nA couple of things make it sing. The no-surcharge policy is the durable edge, because the same EgyptAir or Ethiopian business seat booked through some other programs can carry a few hundred dollars in fuel surcharges, while United keeps the cash portion to modest taxes. Both carriers fly a proper lie-flat business cabin on their widebody jets, EgyptAir on the A350 and 787 and Ethiopian on the 787 and A350, so this is a real bed for an overnight crossing rather than an angled recliner. United shows a good deal of Star Alliance partner space right on united.com, so you can often hunt for a seat and book it online without a phone call, and Africa is exactly the kind of long, expensive trip where trading 88,000 miles for a $4,500 cash fare pays off most. Search a range of dates, because Saver space in the front cabin is genuinely limited and the best days go early.\n\nNow the honest caveats, and there are a few. Earning the miles is the hard part for Canadians, because no Canadian bank transfers directly to United. The cleanest route is Marriott Bonvoy, which moves to United at 3 to 1 with an unusually generous bonus, a full 10,000 extra miles for every 60,000 Bonvoy points you transfer in one block, so 60,000 Bonvoy points land as 30,000 United miles rather than the 25,000 most airlines give you. That still means the 88,000 miles for this seat take on the order of 175,000 Bonvoy points to build, so plan the transfer around a real booking and confirm the current ratio first, since transfers are one-way. The routing is the next catch, because Africa is far and the nonstops are few: EgyptAir's Cairo flights are your cleanest nonstop from the US East Coast, while Ethiopian's US service is thinner and some flights touch down in Europe or West Africa on the way, so check the full routing on your dates before you assume a tidy hop. And because you are starting from Canada, you will still position to a US gateway like New York or Washington on a separate ticket or a short Aeroplan or Avios hop, so price that leg in before you assume the whole trip is cheap. If business space is scarce, that roughly 45,000-mile economy seat on the same partners is the quiet fallback, and it prices just as cleanly with the same low surcharges.",
    href: "/cards?q=marriott",
    hrefLabel: "Bonvoy cards that feed United",
    shortAnswer:
      "United MileagePlus prices its own flights dynamically, but partner awards still sit at semi-fixed Saver levels with no fuel surcharges, and a fresh, durable United sweet spot is a lie-flat Star Alliance seat to Africa on EgyptAir to Cairo or Ethiopian toward Addis Ababa, which has been landing from about 88,000 miles one-way in business, with economy on the same partners from roughly 45,000. On a roughly $4,500 one-way business cash fare booked for 88,000 miles plus about $80 in taxes, that is about 5 cents per mile, well above the 1.5 cents that already counts as a strong use. Earning is the hard part for Canadians, since no Canadian bank transfers directly to United, but Marriott Bonvoy moves there at 3 to 1 with an unusually generous 10,000-mile bonus for every 60,000 Bonvoy points transferred, so 60,000 Bonvoy become 30,000 United miles and the 88,000 for this seat take on the order of 175,000 Bonvoy to build. United no longer publishes a fixed partner chart, so treat 88,000 as an approximate floor and confirm the live price when you search.",
    faqs: [
      {
        q: "How many United miles is business class to Africa?",
        a: "North America to Africa in business on a Star Alliance partner such as EgyptAir or Ethiopian has been landing from about 88,000 miles one-way at United's Saver level, with economy on the same partners from roughly 45,000. Busier dates and the deeper African cities price higher, and United no longer publishes a single fixed partner chart, so treat 88,000 as an approximate floor and confirm the live price when you search.",
      },
      {
        q: "Is business class to Africa a good value on United miles?",
        a: "Yes. On a roughly $4,500 one-way business cash fare booked for 88,000 miles plus about $80 in taxes, the math is (4500 minus 80) divided by 88000, times 100, which is about 5 cents per mile. Anything north of about 1.5 cents is a strong use of United miles, so a flat bed to Africa at this price is your miles doing real work.",
      },
      {
        q: "Does United charge fuel surcharges on EgyptAir or Ethiopian awards?",
        a: "No, and that is the durable edge of this sweet spot. United does not pass along the carrier-imposed fuel surcharges that the same EgyptAir or Ethiopian business seat can carry through some other programs, so the cash portion stays to modest taxes, often around $80 outbound from a US gateway.",
      },
      {
        q: "How do Canadians earn United miles for this?",
        a: "It is the hard part, because no Canadian bank transfers directly to United. The cleanest route is Marriott Bonvoy, which moves to United at 3 to 1 with an unusually generous 10,000-mile bonus for every 60,000 Bonvoy points transferred in one block, so 60,000 Bonvoy points land as 30,000 United miles rather than the 25,000 most airlines give. That means the 88,000 miles for this seat take on the order of 175,000 Bonvoy points to build, so confirm the current ratio first, since transfers are one-way.",
      },
      {
        q: "Can I fly nonstop to Africa on this deal?",
        a: "Sometimes. EgyptAir flies nonstop to Cairo from New York JFK, Newark, and Washington Dulles, with Los Angeles and Chicago joining in 2026, which is your cleanest option. Ethiopian's US service toward Addis Ababa is thinner and some flights touch down in Europe or West Africa on the way, so check the full routing on your dates, and remember you will still position from Canada to a US gateway first.",
      },
      {
        q: "Where in Africa can this take me?",
        a: "EgyptAir's hub is Cairo, the gateway to the pyramids and the Nile, while Ethiopian's Addis Ababa hub connects on one ticket to safari country in Kenya, Tanzania, and South Africa. Both are Star Alliance, so United can string the transatlantic leg and an onward African connection onto a single award booking, subject to partner space.",
      },
    ],
  },
  {
    slug: "delta-flash-sale-hawaii-economy-20k",
    program: "Delta",
    title: "Delta sweet spot: round-trip economy to Hawaii near 20,000 SkyMiles when the flash sales hit",
    dek: "Delta SkyMiles has no award chart and prices dynamically, so the durable Delta play for a Hawaii trip is its standing SkyMiles Award Deals page and the flash sales it runs a few times a year, where in recent rounds round-trip economy from the US West Coast to the islands has been pricing near 20,000 SkyMiles, sometimes lower, against the 40,000-plus these same seats usually cost.",
    read: "5 min read",
    date: "Aug 2026",
    lastChecked: "2026-08-25",
    body:
      "Delta SkyMiles works differently from Aeroplan or Avios, and it is only fair to say so before we talk value. There is no published award chart and no fixed distance bands, so SkyMiles prices awards dynamically, roughly tracking the cash fare, and across the whole program a mile is worth on average a little over a cent, call it about 1.2 cents. We have already walked through two durable Delta sweet spots, the transatlantic flash sale to Europe and the winter run down to the sun in Mexico and the Caribbean, so this time the target is the one that lights up a family's summer: a cheap round trip to Hawaii. The figures below are an example drawn from recent sales, not a quote for any date, so always confirm the live price when you search.\n\nHere is how it works. Delta keeps a standing SkyMiles Award Deals page on delta.com, a permanent feature where a rotating set of discounted award routes is published, and on top of that it runs shorter, sometimes unadvertised flash sales a few times a year. Hawaii is one of the routes worth watching. In the recent rounds, round-trip economy from the US West Coast gateways where Delta flies the islands, Los Angeles, Seattle, and San Francisco, has been pricing near 20,000 SkyMiles, with the very best dates and lightest West Coast runs dipping toward 17,000, and origins from the interior or the East Coast a step up from there. The thing that makes it a sweet spot is the gap: off-sale, those same island seats routinely sit at 40,000 SkyMiles or more, so the sale is the whole game. Because the list rotates and the flash sales are short, this is a book-it-when-you-see-it deal rather than one you plan months ahead, and the cheapest fares are usually the no-frills Main Basic cabin.\n\nHere is the cents-per-mile math on a realistic economy booking. Say a round trip from the West Coast to Honolulu or Maui would otherwise cost about $500 in cash, and the award books for 20,000 SkyMiles plus roughly $22 in taxes and fees, which stay tiny because this is a domestic US routing with no fuel surcharge attached. That works out to (500 minus 22) divided by 20000, times 100, which is about 2.4 cents per mile. Against a program that averages a little over a cent, that is your SkyMiles doing real work, and if you happen to hold an eligible Delta American Express card the TakeOff 15 benefit knocks 15 percent off the mileage, dropping the same seat to about 17,000 miles and nudging the value higher still. Confirm the live fare when you book, because prices move and the example is only there to show the shape of the deal.\n\nOne honest note on TakeOff 15. That 15 percent discount applies only to Delta-operated award flights booked on delta.com, not to partner awards, and it requires an eligible Delta co-branded Amex. Most of those cards are US products that Canadians cannot easily hold, so treat the discount as a nice bonus if you have the card rather than the baseline you should count on.\n\nA couple of things make it sing. Hawaii is a genuine bucket-list trip that a family actually saves up and goes for, and doing it for 20,000 economy miles and a rounding error in taxes turns a pricey summer fare into something you barely feel. The routing is domestic as far as SkyMiles is concerned, so the taxes stay in the low double digits rather than the couple hundred dollars a sun or Europe award carries, and there is no carrier surcharge to swallow. Because the Award Deals page is a standing feature rather than a single fleeting sale, there is always a fresh batch of discounted routes to check rather than one date you have to catch, and Delta's West Coast network into all the main islands, Oahu, Maui, Kauai, and the Big Island, is deep. Search a range of dates within your travel window, because award space at the sale price is genuinely limited and the best days go early.\n\nNow the honest caveats, and there are a few. Earning the SkyMiles is the hard part for Canadians. Amex Canada Membership Rewards does not transfer to Delta, so the cleanest route is Marriott Bonvoy, which moves to Delta at 3 to 1 with no transfer bonus, meaning 60,000 Bonvoy points become 20,000 SkyMiles, so this one seat is on the order of a 60,000-point Bonvoy transfer to build. The other catch is getting there, because Delta does not fly nonstop from Canada to Hawaii: you either string the island leg onto a Delta ticket that connects through a US West Coast hub from Toronto, Montreal, or Vancouver, or you position to Los Angeles, Seattle, or San Francisco separately and start the cheap leg there, so check whether your city and routing actually price at the low number before you assume it. Main Basic is the cheapest bucket for a reason, with no advance seat selection, last boarding group, and no changes, so read the fare rules before you commit, which matters more on a five-plus-hour flight to the islands than on a short hop. And because the deals are dynamically priced and short-lived, there is no date you can plan around in advance, so set an alert on the Award Deals page and pounce when a good one lands.",
    href: "/cards?q=marriott",
    hrefLabel: "Bonvoy cards that feed Delta",
    shortAnswer:
      "Delta SkyMiles has no award chart and prices dynamically, averaging a little over a cent a mile, so the durable Delta play for Hawaii is its standing SkyMiles Award Deals page and the flash sales it runs a few times a year, where in recent rounds round-trip economy from the US West Coast gateways of Los Angeles, Seattle, and San Francisco to the islands has been pricing near 20,000 SkyMiles, with the best dates dipping toward 17,000, against the 40,000-plus those seats usually cost. On a roughly $500 round-trip cash fare booked for 20,000 SkyMiles plus about $22 in taxes, that is around 2.4 cents per mile, and an eligible Delta Amex cardholder's 15 percent TakeOff 15 discount trims the seat to about 17,000 miles. Earning the miles is the hard part for Canadians, since Amex Canada does not transfer to Delta and the cleanest route is Marriott Bonvoy, which moves 3 to 1 with no bonus, so 60,000 Bonvoy becomes 20,000 SkyMiles. These are example figures from recent sales, not a quote for any date, so confirm the live price when you book.",
    faqs: [
      {
        q: "How many SkyMiles is a round trip to Hawaii in Delta's flash sales?",
        a: "In the recent rounds, round-trip economy from the US West Coast gateways Delta flies the islands, Los Angeles, Seattle, and San Francisco, has been pricing near 20,000 SkyMiles, with the very best dates dipping toward 17,000 and interior or East Coast origins a step up. Off-sale those same seats routinely sit at 40,000 SkyMiles or more, so the sale is the whole game, and the cheapest fares are usually the no-frills Main Basic cabin. Delta prices dynamically with no award chart, so confirm the live price when you search.",
      },
      {
        q: "Is a Hawaii Award Deal a good value on Delta?",
        a: "Yes, for economy it is. On a roughly $500 round-trip cash fare booked for 20,000 SkyMiles plus about $22 in taxes, the math is (500 minus 22) divided by 20000, times 100, which is about 2.4 cents per mile. Against a program that averages a little over a cent a mile, that is your SkyMiles doing real work, and the domestic routing keeps the taxes tiny with no fuel surcharge.",
      },
      {
        q: "What is TakeOff 15 and can Canadians use it?",
        a: "TakeOff 15 knocks 15 percent off the mileage on Delta-operated award flights booked on delta.com, so a 20,000-mile Hawaii seat drops to about 17,000. It applies only to Delta-operated flights, not partner awards, and requires an eligible Delta co-branded Amex, most of which are US products Canadians cannot easily hold, so treat it as a nice bonus if you have the card rather than the baseline you count on.",
      },
      {
        q: "How do Canadians earn Delta SkyMiles for this?",
        a: "This is the hard part, because Amex Canada Membership Rewards does not transfer to Delta. The cleanest route is Marriott Bonvoy, which moves to Delta at 3 to 1 with no transfer bonus, so 60,000 Bonvoy points become 20,000 SkyMiles, meaning this one seat is on the order of a 60,000-point Bonvoy transfer to build. Transfers are one-way, so only move points once you have found the seat you want.",
      },
      {
        q: "Can I fly nonstop from Canada to Hawaii on this deal?",
        a: "No, that is the main catch on the routing. Delta does not fly nonstop from Canada to Hawaii, so you either string the island leg onto a Delta ticket that connects through a US West Coast hub from Toronto, Montreal, or Vancouver, or you position to Los Angeles, Seattle, or San Francisco separately and start the cheap leg there. Check whether your city and routing actually price at the low number before you assume it.",
      },
      {
        q: "When is this sweet spot not worth it?",
        a: "When there is no sale on and when the cheap Main Basic fare rules do not suit you. Off-sale, Hawaii seats often sit at 40,000 SkyMiles or more, so this is a book-it-when-you-see-it deal rather than one to plan around a fixed date. The cheapest fares are Main Basic, with no advance seat selection, last boarding group, and no changes, which matters more on a five-plus-hour flight to the islands, so read the fare rules first.",
      },
    ],
  },
  {
    slug: "westjet-companion-voucher-sun-mexico-caribbean-399",
    program: "WestJet",
    title: "WestJet sweet spot: fly a companion to the sun in Mexico or the Caribbean for a fixed $399 base fare",
    dek: "WestJet points are a flat cent each with no award chart, so the winter sweet spot for Canadian families is the RBC companion voucher pointed south, capping a second economy base fare to Mexico, the Caribbean, and the rest of the network at a fixed $399, where a peak-season sun fare would otherwise run far more.",
    read: "5 min read",
    date: "Aug 2026",
    lastChecked: "2026-08-21",
    body:
      "WestJet Rewards works differently from the mileage programs, and it helps to say so up front. WestJet points are worth a flat cent each, 100 points knocks $1 off the base fare, surcharges, bags, and seats, with no award chart and no blackout dates, so there is no hidden business class deal buried in the points the way there is with Aeroplan or Avios. The real WestJet sweet spot for Canadians is the annual companion voucher that comes with the WestJet RBC cards. We have already walked through the everyday version used at home, capping a second fare across Canada and to the continental US at a fixed $119, and the marquee Premium run to Europe for a fixed $499, so this time the target is the trip most families actually book in the depths of a Canadian winter: a companion down to the sun in Mexico or the Caribbean. The figures below are an example of how the voucher works, not a quote for any date, so always confirm the live fare when you book.\n\nHere is how it works. Once a year the WestJet RBC World Elite Mastercard hands you a round-trip companion voucher, and your travel partner books the exact same itinerary as you and pays a fixed base fare instead of the going rate. The catch that matters for a sun trip is which zone your destination falls in. Travel within Canada and the continental US, and Hawaii, sits in the cheaper band at $119 in economy or $219 in Premium, but Mexico, the Caribbean, Central America, and the rest of the WestJet network sit one tier up, at a fixed $399 in economy or $499 in Premium. Popular winter runs like Calgary or Toronto to Cancun, Cabo, Puerto Vallarta, Montego Bay, or Punta Cana all price off that $399 economy base fare. Your companion still owes the taxes and fees, you still pay your own fare in full, and since 2026 WestJet also adds a small fuel surcharge to every companion voucher booking, currently about $40 and tucked into the Other ATC line, that floats with fuel prices, so confirm the live figure. But that second base fare is locked no matter how pricey the route gets.\n\nHere is the value math on a realistic booking. Say a peak-winter economy round trip from Toronto to Cancun prices around $1,100 all in, of which roughly $850 is the base fare the voucher discounts and the rest is taxes and fees. With the World Elite voucher your companion pays the fixed $399 base fare plus those same taxes and fees of about $250, plus the roughly $40 fuel surcharge, so about $690 instead of $1,100. That is roughly $410 off the second seat, on a card whose annual fee is $139, so a single voucher more than pays for the card in one trip south. Confirm the live fare when you book, because prices move and the example is only there to show the shape of the deal.\n\nA couple of things make it sing. The voucher works on any available WestJet fare on the route, so unlike a fixed award chart there are no capacity controls beyond the seats actually being for sale, and the savings scale with how expensive the route is. That makes the pricey peak-season sun dates, Christmas, spring break, and reading week, exactly where you want to spend it, because that is when cash fares to Mexico and the Caribbean balloon. WestJet flies deep into the sun destinations from Calgary, Toronto, and other cities, so most Canadians have a clean way in. One quiet planning note: Hawaii is grouped with the continental US in the cheaper band, so a companion to Maui or Honolulu costs just the $119 economy base fare rather than the $399 sun-zone one, which is worth knowing if the Pacific is on your list. And if the $139 annual fee gives you pause, the no-fee WestJet RBC Mastercard hands you a voucher every year too, just at higher fixed base fares, which is still a genuine perk for a card that costs nothing to hold.\n\nNow the honest caveats, and there are a few. You need two people traveling together on the same booking, and the companion still pays the taxes and fees, which on a sun run usually come to a couple hundred dollars once the Mexican or Caribbean departure taxes are counted, plus that roughly $40 fuel surcharge WestJet now adds to every voucher booking. Together those extras mean the voucher only really wins when the base fare is high, so on a cheap seat-sale fare to Cancun the fixed $399 plus the surcharge and taxes can come out roughly even with just buying two cash tickets, which is why you should always compare the all-in companion price against the all-in cash price before you commit. The voucher is one per year, and the way you unlock it is worth knowing: the first welcome voucher carries no minimum spend, but starting November 5 2026 the World Elite card asks for $5,000 of annual spend to earn the ongoing voucher, though vouchers issued before that date carry no minimum. Peak-season sun seats sell out early, so book ahead and stay flexible, and remember the points themselves are worth a flat cent each, handy for shaving cash off any WestJet fare but not the place to hunt for outsized value.",
    href: "/cards?q=westjet",
    hrefLabel: "WestJet RBC cards",
    shortAnswer:
      "WestJet Rewards points are a flat cent each with no award chart, so the winter sweet spot for Canadian families is the annual RBC companion voucher pointed south. It caps your travel partner's economy base fare to Mexico, the Caribbean, and the rest of the WestJet network at a fixed $399, or $499 in Premium, while Canada, the continental US, and Hawaii sit in a cheaper $119 economy band. On a peak-winter Toronto to Cancun round trip that might sell for around $1,100 all in, the companion pays the fixed $399 base fare plus about $250 in taxes and fees and the roughly $40 fuel surcharge WestJet now adds, so about $690 instead of $1,100, which is around $410 off the second seat on a card whose annual fee is $139. Just know the surcharge and taxes mean the voucher only really wins when the cash fare is high, so on a cheap seat-sale fare it can come out roughly even, and confirm the live fare before you book.",
    faqs: [
      {
        q: "How much does a companion pay to fly to Mexico or the Caribbean with the WestJet voucher?",
        a: "Mexico, the Caribbean, Central America, and the rest of the WestJet network sit in the higher voucher tier, so the companion's base fare is capped at a fixed $399 in economy or $499 in Premium, plus the usual taxes and fees and a fuel surcharge of about $40. Travel within Canada and the continental US, and Hawaii, sits in the cheaper band at $119 in economy or $219 in Premium. You still pay your own fare in full.",
      },
      {
        q: "Is the WestJet companion voucher worth it for a sun trip?",
        a: "It can be, on a pricey peak-season fare. On a peak-winter Toronto to Cancun round trip that might sell for around $1,100 all in, the companion pays the fixed $399 base fare plus about $250 in taxes and fees and the roughly $40 fuel surcharge, so about $690 instead of $1,100. That is roughly $410 off the second seat, on a card whose annual fee is $139, so one voucher more than pays for the card in a single trip south.",
      },
      {
        q: "Does the WestJet companion voucher have a fuel surcharge now?",
        a: "Yes. Since 2026 WestJet adds a fuel surcharge to every companion voucher booking, currently about $40 and shown in the Other ATC line among the taxes and fees. It is a flat amount that floats with fuel prices and applies whether you fly to Calgary or Cancun, so confirm the live figure, and factor it in when you compare the companion price against buying two cash tickets.",
      },
      {
        q: "Does Hawaii count as a sun-zone destination for the voucher?",
        a: "No, and that is a handy quirk. Hawaii is grouped with Canada and the continental US in the cheaper voucher band, so a companion to Maui or Honolulu costs just the $119 economy base fare rather than the $399 Mexico and Caribbean one. If the Pacific is on your list, the voucher stretches even further there.",
      },
      {
        q: "How do I earn the WestJet companion voucher, and is that changing?",
        a: "The voucher comes with the WestJet RBC cards, once after your first purchase and then one more each year. The first welcome voucher carries no minimum spend, but starting November 5 2026 the World Elite card asks for $5,000 of annual spend to unlock the ongoing voucher, though vouchers issued before that date carry no minimum.",
      },
      {
        q: "When is the WestJet companion voucher not worth using for the sun?",
        a: "On a cheap fare. Because the voucher caps the base fare at a fixed $399 and adds the roughly $40 fuel surcharge on top of taxes, a discounted seat-sale round trip to Mexico can come out roughly even with simply buying two cash tickets. The voucher only really wins when the cash fare is high, so save it for the peak Christmas, spring break, or reading-week dates when sun fares balloon.",
      },
    ],
  },
  {
